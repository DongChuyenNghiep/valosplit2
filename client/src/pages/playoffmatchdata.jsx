...
export default function MatchInfo() {
    ...
    const idmatches = ["fce7f3"];
    const quartFinalsIds = ["123n3waaqeswq23"];
    const semiFinalsIds = ["fce7f3"];
    const matchTitles = {
                            ...
                            {['infoTeamleft', 'infoTeamright'].map((team, i) => (
                                <div key={i} className={i === 0 ? 'team-left' : 'team-right'}>
                                    <div className='wrapper'>
                                        <p style={{textAlign:"center",margin:"15px 0 5px"}}>{i === 0 ? match.teamNameleft : match.teamNameright}</p>
                                        <p style={{textAlign:"center",margin:"12px 0 15px"}}>KDA: {calculateKDA(match[team])}</p>
